...
public abstract class Operation {
   ...
   */
  protected abstract void xformInsert(Insert that, OperationInputStream aIn,
      OperationOutputStream aOut, OperationInputStream bIn,
      OperationOutputStream bOut);
   ...
   */
  protected abstract void xformDelete(Delete that, OperationInputStream aIn,
      OperationOutputStream aOut, OperationInputStream bIn,
      OperationOutputStream bOut);
   ...
   */
  protected abstract void xformSkip(Skip that, OperationInputStream aIn,
      OperationOutputStream aOut, OperationInputStream bIn,
      OperationOutputStream bOut);
  ...
  public abstract void composeDispatchSecond(OperationInputStream aIn,
      OperationInputStream bIn, OperationOutputStream out);

  protected abstract void composeInsert(Insert insert, OperationInputStream aIn,
      OperationInputStream bIn, OperationOutputStream out);

  protected abstract void composeDelete(Delete delete, OperationInputStream aIn,
      OperationInputStream bIn, OperationOutputStream out);

  protected abstract void composeSkip(Skip skip, OperationInputStream aIn,
      OperationInputStream bIn, OperationOutputStream out);
   ...
   */
  public abstract void apply(OperationOutputStream out);
  ...
  public static class Insert extends Operation {
    ...
    @Override
    public void apply(OperationOutputStream out) {
      out.insert(text);
    }
    ...
    @Override
    protected void xformInsert(Insert bOp, OperationInputStream aIn,
        OperationOutputStream aOut, OperationInputStream bIn,
        OperationOutputStream bOut) {
      Insert aOp = this;
    ...
    @Override
    protected void xformDelete(Delete bOp, OperationInputStream aIn,
        OperationOutputStream aOut, OperationInputStream bIn,
        OperationOutputStream bOut) {
    ...
    @Override
    protected void xformSkip(Skip bOp, OperationInputStream aIn,
        OperationOutputStream aOut, OperationInputStream bIn,
        OperationOutputStream bOut) {
    ...
    @Override
    public void composeDispatchSecond(OperationInputStream aIn,
        OperationInputStream bIn, OperationOutputStream out) {
      aIn.getCurrent().composeInsert(this, aIn, bIn, out);
    }

    @Override
    protected void composeInsert(Insert insert, OperationInputStream aIn,
        OperationInputStream bIn, OperationOutputStream out) {
    ...
    @Override
    protected void composeDelete(Delete delete, OperationInputStream aIn,
        OperationInputStream bIn, OperationOutputStream out) {
    ...
    @Override
    protected void composeSkip(Skip skip, OperationInputStream aIn,
        OperationInputStream bIn, OperationOutputStream out) {
